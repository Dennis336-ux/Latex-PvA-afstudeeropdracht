...
Het eindresultaat is een gevalideerd `Proof of Concept' dat aantoont dat de nauwkeurigheid en stabiliteit van de tracking hiermee verbeterd is. Dit zal door middel van meerdere veld tests bereikt worden. Op lange termijn wordt er naar gestreefd dat deze methode geïmplementeerd kan worden in de toekomstige generatie hardware van MYLAPS.


\subsection{Vraagstelling}
Uit de context en doelstellingen van MYLAPS is het duidelijk dat de betrouwbaarheid van de positiebepaling centraal staat. Hierom zal deze centrale hoofdvraag gedurende het ontwerptraject centraal staan: 
