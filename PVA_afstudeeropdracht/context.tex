...
Het gebruik van RTK-GNSS biedt dan ook een grote verbetering in precisie, maar kent dus alsnog meerdere gebreken. Het systeem heeft moeite met zichzelf corrigeren en zal dan ook regelmatig foutieve waarden als waarheid zien. In de topsport is garantie voor nauwkeurige data noodzakelijk. Om dit op te lossen wordt gekeken naar Sensor Fusion wat in het hieropvolgende hoofdstuk beschreven wordt.
