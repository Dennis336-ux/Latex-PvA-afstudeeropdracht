...
Specifiek voor de paardensport (horse racing) heeft MYLAPS momenteel een proof of concept ontwikkeld. Dit systeem maakt gebruik van de eerder beschreven RKT GNSS-technologie en is in theorie in staat om posities tot op enkele centimeters nauwkeurig te bepalen. Deze nauwkeurigheid moet echter gegarandeerd worden en eventueel opgevangen worden bij foutieve of missende data. \\
