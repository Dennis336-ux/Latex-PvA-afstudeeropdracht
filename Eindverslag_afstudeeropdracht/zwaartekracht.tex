...
de pitch als de rollhoek meegenomen. Hoewel deze methode gebaseerd is op de correcte wiskunde, bleek tijdens het testen dat er alsnog foutieve waardes ontstonden. De uiteindelijke implementatie gebruikt dan ook alleen de pitchhoek, zoals beschreven in sectie~\ref{subsubsec:gravity_comp}. Deze bijlage bevat 
...
beschreven in sectie~\ref{subsubsec:gravity_comp}.