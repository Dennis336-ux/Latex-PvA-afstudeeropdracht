\section*{A \quad Begrippenlijst}
\addcontentsline{toc}{section}{Begrippenlijst}
...
\begin{longtable}{p{4.5cm} p{10cm}}
    ...
    te lineariseren. Vormt de kern van het sensor fusion systeem
    in dit project. \\
    ...
    Bepaalt de positie via trilateration op basis van
    ...
    de GNSS meting krijgt ten opzichte van de eigen voorspelling
    ...
    noordrichting en de kruisterm. Beschikbaar op 1\,Hz. \\

    NAV-PVT &
    UBX-bericht van de u-blox ontvanger dat positie, snelheid
    en nauwkeurigheidsschatting (hAcc) bevat.
    Beschikbaar op 25\,Hz. \\

    NIS (Normalized Innovation Squared) &
    Statistische toets die meet hoe verrassend een binnenkomende
    GNSS-meting is gegeven de huidige filterstaat. Wordt gebruikt
    om foutieve metingen te detecteren en te verwerpen. \\

    nRF52832 &
    Microcontroller van Nordic Semiconductor met een ARM
    Cortex-M4F processor en hardware FPU. Vormt de rekenkern
    van de ProRTK tracker. \\
    ...
    1--2\,cm door gebruik te maken van een basisstation dat
    real-time correcties stuurt naar de mobiele ontvanger. \\

    RTK Fixed &
    Operatiemodus van de RTK-ontvanger waarbij de
    fase-ambiguïteiten volledig zijn opgelost. Geeft de hoogste
    nauwkeurigheid van 1--2\,cm. \\

    RTK Float &
    Operatiemodus van de RTK-ontvanger waarbij de
    fase-ambiguïteiten nog niet definitief zijn opgelost.
    Nauwkeurigheid typisch 10--50\,cm. \\
    ...
    tussen de microcontroller en randapparatuur. De IMU,
    seriële flash en CAN-controller delen dezelfde SPI-bus
    op de ProRTK. \\

    Toestandsvector ($\mathbf{x}$) &
    ...
    UBX &
    Binair communicatieprotocol van u-blox voor efficiënte
    overdracht van GNSS-data tussen de ontvanger en de
    microcontroller. \\

    u-blox X20P &
    RTK GNSS-ontvanger geïntegreerd in de ProRTK tracker.
    Levert positie, snelheid en nauwkeurigheidsmarges via
    het UBX-protocol. \\
    ...
    WGS84 &
    Wereldwijd coördinatenstelsel dat geografische coördinaten
    definieert ten opzichte van een referentie-ellipsoïde.
    Standaard coördinatenstelsel voor GNSS-ontvangers. \\

    X2 Link &
    Draadloos communicatieprotocol van MYLAPS voor de overdracht
    van positie- en tijddata van de tracker naar de
    MYLAPS-server. \\

    ZUPT (Zero Velocity Update) &
    Extra correctiestap in het EKF die de snelheidsschatting
    naar nul trekt wanneer het systeem als stilstaand wordt
    gedetecteerd. Voorkomt positiedrift bij stilstand. \\
